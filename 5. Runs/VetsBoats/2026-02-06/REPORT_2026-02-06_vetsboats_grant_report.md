# Wooden Boats for Veterans (VetsBoats)
# Monthly Grant Opportunities Report
...
1. [If You Only Have 5 Hours This Month](#if-you-only-have-5-hours-this-month)
2. [This Month's Focus](#this-months-focus)
3. [Important: Private Foundation Status Advisory](#important-private-foundation-status-advisory)
4. [Foundation Types Explained](#foundation-types-explained)
5. [Foundations at a Glance](#foundations-at-a-glance)
6. [Foundation Profiles](#foundation-profiles)
7. [Monthly Action Plan](#monthly-action-plan)
...
## Important: Private Foundation Status Advisory

VetsBoats is classified as a **private foundation** (IRS BMF foundation code 03, filing Form 990-PF). This is different from a public charity (501(c)(3) with public support), and it affects grant eligibility.

**What this means for your applications:**

- Some foundations restrict grants to "public charities" or "501(c)(3) organizations that are not private foundations." Always check guidelines before applying.
- All 5 foundations in this report have been verified as either having funded other private foundations before OR having no stated restrictions against it.
- When applying, include your IRS determination letter and be transparent about your classification.

**Recommended actions:**

1. Obtain a copy of your current IRS determination letter
2. Consult with your tax advisor about the operating foundation checkbox on your 990-PF (marked FALSE since 2019, if this is a filing error, correcting it strengthens your position)
3. If asked about your status, emphasize that VetsBoats operates direct programs (therapeutic sailing, boat restoration) rather than making grants to other organizations
...
### Open Application
**What it means:** Foundation has a submission process (online portal, email, specific forms). You submit your request during their open window.

**Your action:** Complete and submit application this month.

### LOI-Ready
**What it means:** Foundation accepts unsolicited Letters of Inquiry (2-3 page summary of your org and request). If they're interested, they'll invite you to submit a full proposal.

**Your action:** Write and submit LOI this month.

### Cultivation
**What it means:** Foundation is invitation-only or rarely funds without existing relationship. Cold applications have very low success rates.

**Your action:** Research staff/board, identify connections, begin relationship-building. Application comes later (months to years).

**Note:** Cultivation foundations are only included in this report when there is:

- Near-perfect alignment with your mission, geography, and funding needs, AND
- A clear path to relationship (you have a connection to their board/staff, they host accessible events, or a shared grantee can introduce you)
...
| Rank | Foundation | Typical Grant | Type | Your Time |
|------|------------|---------------|------|-----------|
| 1 | Bill Simpson Foundation | $10,000-$80,000 | Open Application | 5 hrs |
| 2 | Albert & Ethel Herzstein | $8,000-$25,000 | LOI-Ready | 4 hrs |
| 3 | Kovler Family Foundation | $3,000-$5,000 | LOI-Ready | 3 hrs |
| 4 | John & Daria Barry Foundation | $25,000-$100,000 | Cultivation | 3 hrs |
| 5 | Van Beuren Charitable Foundation | $15,000-$30,000 | LOI-Ready | 3 hrs |
...
|-------------------|---------------|
| Grants to **adaptive sailing/disability recreation** orgs | **CRAB** received **$80,000** for adaptive sailing + Special Olympics (2024); **Freedom Waters** received **$10,000** (2023) |
| Grants to therapeutic programs | **Jackson Hole Therapeutic Riding** received **$15,000** (2024) |
| California grants | **3 grants** to CA orgs including Guide Dogs of the Desert ($50,000 + $30,000) |
| Most similar grantee to you | **Chesapeake Region Accessible Boating (CRAB)**, adaptive sailing for people with disabilities. CRAB went from $10K (2023) to $80K (2024). |
...
| Element | Details |
|---------|---------|
| Letter of Inquiry | 2 pages: org background, mission, programs, funding request |
...
**Key Officers:** Dillon Simpson, Sabrina Simpson (family), Jesse Horn, Michael Mock, Michael Cordesius, Elizabeth Burdette (SignatureFD advisor)
...
|-----------------|---------|
| Board Overlap | None identified |
| Shared Grantees | **CRAB** (adaptive sailing), similar mission to VetsBoats |
| Geographic | **Guide Dogs of the Desert** ($50K+$30K to CA) confirms they fund West Coast orgs |
| Sector | Strong disability/accessibility pattern: CRAB, Freedom Waters, Guide Dogs, Jackson Hole Therapeutic Riding |

---

#### Positioning Strategy

Lead with the CRAB precedent. Bill Simpson gave CRAB $80,000 for adaptive sailing in 2024, up from $10,000 the prior year. VetsBoats is the West Coast equivalent: therapeutic sailing for veterans with PTSD and disabilities on San Francisco Bay. The foundation clearly values general support (85% of grants), so request unrestricted funding for VetsBoats' core therapeutic sailing program. Given CRAB's trajectory ($10K → $80K in one year), request $15,000-$25,000 as a first grant with the potential to grow.

**Note on PF status:** This foundation has zero prior grants to private foundations in our database. No stated restrictions against PFs either. Be transparent about your classification in the LOI and include your determination letter.
...
**Then:** Wait through April review period. If funded, expect notification by late spring/early summer.
...
#### How to Apply: LOI Process

**Submission Method:** Online portal at herzsteinfoundation.org

**LOI Requirements:**

| Element | Requirement |
|---------|-------------|
| Format | Online application portal |
| Must Include | Organization description, project need, budget, amount requested |
| Attachments | IRS determination letter, financials, board list |

**After You Submit:**

- Foundation reviews on rolling basis
- Contact: Renee Masaryk (President)
- Peter Nagel JD was Grants Officer; position may have been open, use portal regardless

**Deadline:** Rolling, submit when ready
...
| Role | Name | Contact | Use For |
|------|------|---------|---------|
| President | Renee Masaryk | rmasaryk@herzsteinfoundation.org | Strategic questions, eligibility confirmation |
| General | — | mail@herzsteinfoundation.org / (713) 681-7868 | General inquiries |
| Board Chairman | George W. Strake III | Via foundation | Board relationships |

**Foundation Website:** [herzsteinfoundation.org](https://www.herzsteinfoundation.org)

**Application Portal:** [herzsteinfoundation.org](https://www.herzsteinfoundation.org) (grants section)

**Phone:** (713) 681-7868

**Other Board/Staff:** Steven Goodman, Kenneth Katz, Craig Loewenstern, Bryan Miller, Mike Viator
...
| Connection Type | Details |
|-----------------|---------|
| Board Overlap | None identified for Matt Goettelman. Houston TX business/philanthropy network |
| Shared Grantees | **Sailing Angels Foundation**, therapeutic sailing for people with disabilities in TX waters |
| Geographic | 88% Texas, strongest connection is through VetsBoats' planned Galveston expansion |
| Sector | Funds both sailing AND veteran orgs. VetsBoats sits at the intersection |
...
| Step | Task | Time | Depends On |
|------|------|------|------------|
| 1 | Review herzsteinfoundation.org guidelines and portal | 30 min | — |
| 2 | Draft LOI emphasizing Galveston expansion + Sailing Angels parallel | 2.5 hrs | — |
| 3 | Prepare Galveston expansion budget and timeline | 30 min | — |
| 4 | Submit via online portal with attachments | 30 min | Steps 2-3 |
| 5 | **WAIT**: Rolling review | — | Step 4 |
| 6 | Follow up with Renee Masaryk if no response in 8 weeks | 15 min | Step 4 + 8 weeks |

**Total Active Time:** 4 hours

**Then:** Rolling review. Expect response within 6-10 weeks. If invited to full proposal, additional 3-4 hours.
...
**Submission Method:** Mail or call
...
| Address | 875 N. Michigan Avenue, Suite 3400, Chicago, IL 60611 |
| Phone | (312) 664-5050 |

**Deadline:** Mid-November (for following year grants)

**After You Submit:**

- Foundation reviews annually
- If interested: Invited to submit full proposal
- Jonathan Kovler (Chairman) and family make final decisions
...
| Role | Name | Contact | Use For |
|------|------|---------|---------|
| Chairman | Jonathan Kovler | (312) 664-5050 | Foundation decisions |
| Applications | — | app@kovler-b.com | Application submissions |
| Foundation | General | 875 N Michigan Ave, Suite 3400, Chicago IL 60611 | LOI submission |

**Key Family Members:** Jonathan Kovler (former Chicago Bulls managing partner), Sally Kovler, Benjamin Kovler (CEO, Green Thumb Industries)
...
| Connection Type | Details |
|-----------------|---------|
| **Goldman Sachs** | **STRONG. Matt Goettelman → Ron Levin → Benjamin Kovler.** Ron Levin is a Goldman Sachs Managing Director in Chicago Private Wealth Management. He co-founded Invest For Kids with Benjamin Kovler. Levin and Goettelman are colleagues in the same GS division. |
| Shared Grantees | **Judd Goldman Adaptive Sailing Foundation**, adaptive sailing for people with disabilities |
| Geographic | 51 CA grants (9% of portfolio), they do fund West Coast organizations |
| Sector | Disability/accessibility pattern through Judd Goldman Adaptive Sailing |

---

#### Positioning Strategy

**Use the Matt Goettelman connection first.** Before submitting a cold LOI, ask Matt if he knows Ron Levin in Goldman Sachs' Chicago PWM office. If Matt can get a warm introduction through Levin to the Kovler family, the probability of funding increases dramatically. The Judd Goldman Adaptive Sailing Foundation is the perfect talking point. VetsBoats does the same work for veterans on the West Coast. Note that typical grants are small ($3K-$5K), so this is a relationship-building opportunity rather than a major funding source. Request $5,000 for general operating support, matching their adaptive sailing grant size.
...
| Step | Task | Time | Depends On |
|------|------|------|------------|
| 1 | Ask Matt Goettelman: "Do you know Ron Levin in GS Chicago PWM?" | 30 min | — |
| 2 | If Matt knows Levin: Request introduction to Benjamin Kovler via Levin | 30 min | Step 1 |
| 3 | Draft LOI referencing Judd Goldman Adaptive Sailing as precedent | 1.5 hrs | — |
| 4 | Submit LOI by mid-November deadline | 30 min | Step 3 |
| 5 | **WAIT**: Annual review cycle | — | Step 4 |

**Total Active Time:** 3 hours (can start with Matt Goettelman outreach immediately; LOI draft closer to November)

**Then:** Annual review cycle. Decision by early following year.
...
**Your Time Investment:** 3 hours (research phase)

**Potential Award:** $25,000 - $100,000
...
| Metric | Value |
|--------|-------|
| **Annual Giving** | $16.4M across 26 grants/year |
| **Typical Grant** | $100,000 median (range: $2,500 - $9,479,353) |
| **Geographic Focus** | NY (37%), RI (15%), CT (15%), CA (6%), FL (12%), multi-state |
| **Repeat Funding Rate** | 57% funded 2+ times |
| **Giving Style** | Strategic, large grants to a focused portfolio |
| **Funding Trend** | Stable, consistent giving pattern; total assets $477M |

---

#### How to Approach: Cultivation Required

**Why Cultivation:** The foundation website explicitly states: *"The John and Daria Barry Foundation does not consider unsolicited requests for funding."* All grants are identified through personal relationships and trusted intermediaries.
...
- **Sail to Prevail** (Newport, RI), $125K total for therapeutic sailing. VetsBoats' closest East Coast parallel.
- **Guardian Revival** (NY), $1.2M for veteran mental health. Service dogs for veterans.
...
| Role | Name | Contact | Use For |
|------|------|---------|---------|
| Sole Trustee | John Francis Barry III | Via Prospect Capital Management | All decisions |
| Co-Founder | Daria Becker Barry | Via Prospect Capital Management | Veterans portfolio |

**Foundation Website:** [barryfamilyfoundation.org](https://www.barryfamilyfoundation.org) (minimal, deliberately low public profile)

**Professional Contact:** Prospect Capital Management, [prospectcap.com](https://www.prospectcap.com)
...
| Step | Task | Time | Depends On |
|------|------|------|------------|
| 1 | Research Sail to Prevail: who runs it, mission overlap, potential for collaboration | 1 hr | — |
| 2 | Reach out to Sail to Prevail to explore partnership or introduction | 30 min | Step 1 |
| 3 | Ask Matt Goettelman about connections to Prospect Capital / John Barry III network | 30 min | — |
| 4 | Review barryfamilyfoundation.org for recent giving and priorities | 30 min | — |
| 5 | Draft a one-pager on VetsBoats to share when the introduction happens | 30 min | Steps 1-3 |

**Total Active Time:** 3 hours (research and outreach phase)

**Then:** Relationship building is a 6-12 month process. The goal this month is to make first contact with Sail to Prevail and explore the Matt Goettelman connection. Don't expect a grant conversation for months.
...
|---|---|---|
| Program & Project | **July 2026** (February deadline has passed) | November |
...
| Step | Action | Why |
|------|--------|-----|
| 1 | **Contact Kaila Acheson for intro call** | Required for first-time applicants. Use this call to gauge interest in an out-of-state adaptive sailing program. |
| 2 | **Connect with Sail to Prevail** | Van Beuren funds Sail to Prevail $25-30K/yr. Barry Foundation (#4) also funds them. A Sail to Prevail endorsement strengthens your application. |
| 3 | **Position VetsBoats as the West Coast Sail to Prevail** | VetsBoats and Sail to Prevail run nearly identical programs. Van Beuren already values this work at $25-30K/year. |
...
**Giving Focus:** Newport County, RI community + sailing/maritime
...
| Connection Type | Details |
|-----------------|---------|
| **Shared Grantee (strongest path)** | **Sail to Prevail**, Van Beuren and Barry Foundation BOTH fund this org. A single relationship with Sail to Prevail opens doors to two funders simultaneously. |
| Sailing Community | IYRS School of Technology & Trades, Sail Newport, Herreshoff Marine Museum, Conanicut Island Sailing, deep roots in America's sailing community |
| Board Overlap | None identified for Matt Goettelman. Newport RI / sailing / philanthropy network |
| Geographic | 50% Rhode Island, 20% New York. However, they fund national orgs (Oceana/Sailors for the Sea) and regularly add new grantees. |
...
**Total Active Time:** 3 hours (intro call will determine whether to pursue July application or shift to Capacity Building track)

**July Deadline:** Program & Project grants, notification by November 2026
...
| Week | Foundation | Tasks | Time |
|------|------------|-------|------|
| **Week 1** | #1 Bill Simpson | Review website → Draft LOI → Gather attachments | 4.5 hrs |
| | #3 Kovler | Ask Matt Goettelman about Ron Levin at Goldman Sachs | 30 min |
| **Week 2** | #1 Bill Simpson | Review and submit LOI via email | 30 min |
| | #2 Herzstein | Review portal → Draft LOI with Galveston expansion angle | 3 hrs |
| **Week 3** | #2 Herzstein | Submit via online portal | 1 hr |
| **Week 3-4** | #4 Barry | Research Sail to Prevail → Reach out for introduction | 2 hrs |
| | #5 Van Beuren | Email Kaila Acheson for intro call; review vbcfoundation.org; assess July application | 1 hr |

**Total This Month:** ~18 hours (per-foundation estimates from priority table; some steps overlap in practice)

### What You'll Be Waiting On

*After submissions, the ball is in their court:*
...
| #5 Van Beuren | July (if eligible) | Notification by November | After intro call with Kaila Acheson |
...
| **#5 Van Beuren** (LOI-Ready) | Email Kaila Acheson for intro call → Assess geographic eligibility → [If eligible] Apply by July → WAIT → Notification by November |
...
| #5 Van Beuren | LOI-Ready | **July 2026** (rolling for Capacity Building) | Contact Kaila Acheson for intro call → apply via portal |
...
- **Months 3-4:** If invited, write full proposal (10-20 hours)
- **Months 4-6:** Wait for review + board decision
- **Months 6-9:** Decision received

**This report covers Month 1.** Expect decisions in 4-9 months for the application-ready foundations (#1-3, #5). Barry (#4) is a cultivation foundation operating on a 6-18 month timeline. Note that Barry and Van Beuren (#5) share the Sail to Prevail connection, building that relationship strengthens both paths.

**Prepared by:** TheGrantScout Research Team
...
**Grant History:** IRS Form 990-PF filings (2016-2024)

**Contact Information:** Foundation websites, public sources

**Application Process:** Foundation websites, Instrumentl, direct inquiry

**Connection Paths:** Public professional profiles, organizational websites

*Application processes may change. Verify current information with foundations before submitting.*
